...
public class Resource {
    ...
    private int id; // Unique identifier for the Resource its autogenerated
    ...
    @OneToMany(mappedBy = "resource", orphanRemoval = true) //Provides mapping for likes to resources, orphan removal is used to get rid of likes on deleted resources
    @JsonIgnore
    private List<Likes> likes = new ArrayList<>();

    @OneToMany(mappedBy = "resource", orphanRemoval = true) //Provides mapping for comments to resources, 
    private List<Comment> comments = new ArrayList<>();

    @OneToMany(mappedBy = "resource", orphanRemoval = true) //Provides mapping table for tags to resources
    private List<ResourceTag> tags = new ArrayList<>();

    @Transient
    private Iterable<Integer> tagIds; // Keeps track of tags associated with resource
