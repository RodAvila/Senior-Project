...
public class emails {
    ...
    static String  d_email = "udl4cs.no.reply@gmail.com",
            ...
            m_subject = "Test File";
    public void sendEmail(File attach, String title) {
    ...
    private static Multipart getMultipart(File attach, String title) throws MessagingException, IOException {
        ...
        text = "<br><br><a href='https://en.wikipedia.org/wiki/Cat'>Approve this document</a><br>";
        text += "<a href='https://en.wikipedia.org/wiki/Cat'>Deny this document</a><br>";
